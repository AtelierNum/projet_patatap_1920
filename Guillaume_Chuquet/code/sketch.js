...
function preload() {
    ...
    soundA = loadSound("sounds/soundA.wav")
    soundB = loadSound("sounds/soundB.wav")
    soundC = loadSound("sounds/soundC.wav")
    soundD = loadSound("sounds/soundD.wav")
    soundE = loadSound("sounds/soundE.wav")
    soundF = loadSound("sounds/soundF.wav")
    soundG = loadSound("sounds/soundG.wav")
    soundH = loadSound("sounds/soundH.wav")
    soundI = loadSound("sounds/soundI.wav")
    soundJ = loadSound("sounds/soundJ.wav")
    soundK = loadSound("sounds/soundK.wav")
    soundL = loadSound("sounds/soundL.wav")
    soundM = loadSound("sounds/soundM.wav")
    soundN = loadSound("sounds/soundN.wav")
    soundO = loadSound("sounds/soundO.wav")
    soundP = loadSound("sounds/soundP.wav")
    soundQ = loadSound("sounds/soundQ.wav")
    soundR = loadSound("sounds/soundR.wav")
    soundS = loadSound("sounds/soundS.wav")
    soundT = loadSound("sounds/soundT.wav")
    soundU = loadSound("sounds/soundU.wav")
    soundV = loadSound("sounds/soundV.wav")
    soundW = loadSound("sounds/soundW.wav")
    soundX = loadSound("sounds/soundX.wav")
    soundY = loadSound("sounds/soundY.wav")
    soundZ = loadSound("sounds/soundZ.wav")
